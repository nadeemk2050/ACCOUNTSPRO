...
function createWindow() {
    ...
    console.log("Target HTML:", indexHtml);

    if (fs.existsSync(indexHtml)) {
        win.loadFile(indexHtml).catch(err => {
            dialog.showErrorBox("Startup Error", "Failed to load index.html: " + err.message);
        });
    } else {
        ...
        if (fs.existsSync(rootIndex)) {
            ...
            dialog.showErrorBox("Missing Files", "The application files were not found. Expected: " + indexHtml);
        }
    }
