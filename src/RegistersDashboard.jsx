...
const RegistersDashboard = ({
    ...
    const modules = [
        ...
        { id: 'expense_reg', name: 'Expenses Register', action: onShowExpenseRegister, v2: true, desc: 'Operating & administrative costs' },
        { id: 'income_reg', name: 'Indirect Incomes', action: onShowIncomeRegister, v2: true, desc: 'Non-operating revenue sources' },
